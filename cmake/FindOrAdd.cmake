...
set(CC_DEPS_ROOT        "${ROOT_DIR}/3rdparty/.deps" CACHE PATH "")
set(FETCHCONTENT_BASE_DIR "${CC_DEPS_ROOT}"          CACHE PATH "")

message(STATUS "Deps directory:              ${CC_DEPS_ROOT}")
...
function(find_or_fetch_package package_name)
    ...
    # Define paths
    set(PKG_SOURCE_DIR "${CC_DEPS_ROOT}/${package_name_lower}-src")
    ...
    if(ALREADY_DOWNLOADED)
        ...
        set(MARKER_FILE "${PKG_SOURCE_DIR}/.cc_postfetch_done")
    ...
    if(NOT ${package_name_lower}_POPULATED)
        ...
        # Create marker file
        if(ARG_POST_FETCH_SCRIPT OR ARG_POST_FETCH_COMMANDS)
            set(MARKER_FILE "${${package_name_lower}_SOURCE_DIR}/.cc_postfetch_done")
            file(WRITE "${MARKER_FILE}" "Post-fetch operations completed")
        endif()
